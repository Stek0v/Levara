...
class TestCollections:
    def test_no_collections_initially(self):
        adapter = _make_adapter()
        result = asyncio.get_event_loop().run_until_complete(adapter.has_collection("col"))
        assert result is False

    def test_create_collection(self):
        adapter = _make_adapter()
        asyncio.get_event_loop().run_until_complete(adapter.create_collection("col"))
        assert asyncio.get_event_loop().run_until_complete(adapter.has_collection("col")) is True
