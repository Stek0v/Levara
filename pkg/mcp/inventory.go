...
var groupByName = map[string]string{
	...
	"memory_markdown_digest": "memory",
	"memory_scaffold_block":  "memory",
	"list_memories":          "memory",
	"consolidate":            "memory",
	"consolidation_status":   "memory",
	"consolidation_revert":   "memory",
	"memory_index_status":    "ops",
	"memory_index_retry":     "ops",
	"wake_up":                "memory",
	"pin_memory":             "memory",
	"unpin_memory":           "memory",
...
func deriveGroup(name string) string {
	...
	if strings.HasPrefix(name, "memory_commit_") {
		return "memory"
	}
