...
const ru: Dict = {
  ...
  'document.access.title': 'Доступ к документу',
  'document.access.button': 'Доступ',
  'document.access.policy': 'Политика',
  'document.access.revision': 'версия',
  'document.access.kind': 'Тип получателя',
  'document.access.user': 'Пользователь',
  'document.access.group': 'Группа',
  'document.access.recipient': 'Получатель',
  'document.access.unregistered': 'Для документа ещё не включена отдельная политика доступа.',
  'document.access.enable': 'Включить отдельный доступ',
  'document.access.noRecipients': 'Нет доступных получателей этого типа',
  'document.access.stale': 'Политика изменилась. Данные обновлены — повторите действие.',
  'document.access.error': 'Не удалось изменить доступ',
  'documents.shared.title': 'Документы, доступные отдельно',
...
const en: Dict = {
  ...
  'document.access.title': 'Document access',
  'document.access.button': 'Access',
  'document.access.policy': 'Policy',
  'document.access.revision': 'revision',
  'document.access.kind': 'Recipient type',
  'document.access.user': 'User',
  'document.access.group': 'Group',
  'document.access.recipient': 'Recipient',
  'document.access.unregistered': 'This document does not have an individual access policy yet.',
  'document.access.enable': 'Enable document access',
  'document.access.noRecipients': 'No recipients of this type are available',
  'document.access.stale': 'The policy changed. Data was refreshed; try again.',
  'document.access.error': 'Failed to change access',
  'documents.shared.title': 'Documents shared directly with you',
  'mem.title': 'Memories',
  'mem.add': 'Add Memory',
  'mem.save': 'Save',
  'mem.cancel': 'Cancel',
