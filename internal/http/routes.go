...
func RESTRouteInventory() []RouteSpec {
	return []RouteSpec{
		...
		{Method: "PATCH", Path: "/datasets/:id", Status: APICanonical, Group: "datasets"},
		{Method: "GET", Path: "/datasets/:id/commits", Status: APICanonical, Group: "datasets"},
		...
		{Method: "GET", Path: "/datasets/:id/data/:dataId/structured-artifacts/:artifactId", Status: APICanonical, Group: "datasets"},
		{Method: "GET", Path: "/datasets/:id/data/:dataId", Status: APICanonical, Group: "documents"},
		{Method: "POST", Path: "/datasets/:id/data/:dataId/policy", Status: APICanonical, Group: "documents"},
		{Method: "GET", Path: "/datasets/:id/data/:dataId/policy", Status: APICanonical, Group: "documents"},
		{Method: "GET", Path: "/datasets/:id/data/:dataId/recipients", Status: APICanonical, Group: "documents"},
		{Method: "PATCH", Path: "/datasets/:id/data/:dataId/policy", Status: APICanonical, Group: "documents"},
		{Method: "POST", Path: "/datasets/:id/data/:dataId/grants", Status: APICanonical, Group: "documents"},
		{Method: "DELETE", Path: "/datasets/:id/data/:dataId/grants/:kind/:principalId", Status: APICanonical, Group: "documents"},
		{Method: "POST", Path: "/document-groups", Status: APICanonical, Group: "documents"},
		{Method: "GET", Path: "/document-groups/:groupId", Status: APICanonical, Group: "documents"},
		{Method: "PUT", Path: "/document-groups/:groupId/members", Status: APICanonical, Group: "documents"},
		{Method: "GET", Path: "/documents/shared", Status: APICanonical, Group: "documents"},
		...
		{Method: "DELETE", Path: "/collections/:name/records/:id", Status: APICanonical, Group: "collections"},
		...
		{Method: "GET", Path: "/embedding-migrations/dual-write", Status: APICanonical, Group: "collections"},
		{Method: "DELETE", Path: "/embedding-migrations/dual-write/:source", Status: APICanonical, Group: "collections"},
		...
		{Method: "POST", Path: "/chats/import", Status: APICanonical, Group: "chats"},
		...
		{Method: "DELETE", Path: "/memories/by-id/:id", Status: APICanonical, Group: "memory"},
		...
		{Method: "POST", Path: "/sync/run", Status: APICanonical, Group: "sync"},
		{Method: "GET", Path: "/sync/status", Status: APICanonical, Group: "sync"},
		...
		{Method: "POST", Path: "/workspace/search", Status: APICanonical, Group: "workspace"},
		...
		{Method: "GET", Path: "/admin/mcp/tools", Status: APICanonical, Group: "admin"},
		{Method: "GET", Path: "/admin/mcp/summary", Status: APICanonical, Group: "admin"},
		{Method: "GET", Path: "/admin/mcp/sessions", Status: APICanonical, Group: "admin"},
		...
		{Method: "POST", Path: "/memory-reviews/run", Status: APIOps, Group: "mcp"},
		{Method: "GET", Path: "/memory-reviews", Status: APIOps, Group: "mcp"},
		{Method: "GET", Path: "/memory-reviews/:id", Status: APIOps, Group: "mcp"},
		...
		{Method: "GET", Path: "/memory-index/status", Status: APIOps, Group: "memory"},
		...
		{Method: "GET", Path: "/vsa/status", Status: APICanonical, Group: "vsa"},
		...
		{Method: "POST", Path: "/search", Status: APILegacy, Group: "vector"},
