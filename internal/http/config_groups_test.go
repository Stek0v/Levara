...
func sampleAPIConfig() APIConfig {
	return APIConfig{
		...
		ErrorTracker:               nil,
		FileStorage:                nil,
		StructuredExtractEndpoint:  "http://lift-sidecar/extract",
		StructuredExtractTimeoutMs: 120000,
		Logger:                     nil,
...
func TestConfigGroupProjectionsPreserveFacts(t *testing.T) {
	...
	rebuilt := APIConfig{
		...
		StructuredExtractEndpoint:  st.StructuredExtractEndpoint,
		StructuredExtractTimeoutMs: st.StructuredExtractTimeoutMs,
		// AuditConfig
