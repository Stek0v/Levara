...
var (
	...
	SearchDuration = promauto.NewHistogram(prometheus.HistogramOpts{
		Name:    "cognevra_search_duration_seconds",
	...
	InsertDuration = promauto.NewHistogram(prometheus.HistogramOpts{
		Name:    "cognevra_insert_duration_seconds",
