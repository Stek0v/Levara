...
- `GET /embedding-migrations/dual-write` и `DELETE /embedding-migrations/dual-write/:source` позволяют инспектировать и вручную выключать active dual-write windows.
